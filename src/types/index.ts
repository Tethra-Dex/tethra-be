export interface PriceData {
  ...
  publishTime?: number;
  // Optional exact raw value (useful for precise signing/conversion)
  rawPrice?: string;
  decimals?: number;
}
...
export const SUPPORTED_ASSETS: AssetConfig[] = [
  ...
  // RWA / Commodities (Chainlink feeds)
  { symbol: 'XAUUSD', tradingViewSymbol: 'TVC:GOLD' },
  { symbol: 'USOIL', tradingViewSymbol: 'TVC:USOIL' },

  // Forex (Chainlink feeds)
  { symbol: 'EURUSD', tradingViewSymbol: 'FX:EURUSD' },
  { symbol: 'GBPUSD', tradingViewSymbol: 'FX:GBPUSD' },

  // Index (Chainlink feeds) - naming follows common market conventions
  { symbol: 'US30', tradingViewSymbol: 'TVC:DJI' },
  { symbol: 'NASDAQ', tradingViewSymbol: 'TVC:NDX' },
];
